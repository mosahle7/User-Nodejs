...
const CreateEmoji = (getUserId) => {
  return (
    <>
     <div> User {getUserId} successfully created !</div>
    <svg viewBox="0 0 800 800" style={{ marginTop: '-54px', marginLeft: '178px' }} width="80px" height="80px">
