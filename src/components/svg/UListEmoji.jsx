...
const Emoji = () => {
  return (
    <>
     <div> Oops, List is empty! Start creating users</div>
     {/* <div>User  successfully created!</div> */}
     {/* <svg viewBox="0 0 800 800" style={{ marginTop: '-54px', marginLeft: '159px' }} width="80px" height="80px"> */}
    <svg viewBox="0 0 800 800" style={{ marginTop: '-55px', marginLeft: '75px' }} width="80px" height="80px">
